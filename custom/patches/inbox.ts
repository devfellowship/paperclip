...
export function computeInboxBadgeData({
  ...
  // PATCH: count only unread issues, not all touched ones. Upstream commit
  // 21d2b075 ("Fix inbox badge logic and landing view") moved badge calc to
  // the client and started counting every touched issue — including done ones.
  // We want the historical behavior: badge = unread only.
